...
const Resume = () => {
  ...
  const resume = (
    <>
      ...
      <br />
      <P onClick={() => moveToVideo(30.5)}>
        ▶ Office Automation Portfolio (0:30)
      </P>
      <br />
  ...
  const stack = (
    <>
      ...
      <br />
      <p>
        <SubColor>❏ 퍼블리싱</SubColor> : 디자인 가이드 그대로 구현 가능 (반응형
        포함) <br />
        <br />
        <SubColor>❏ 자바스크립트</SubColor> : 함수와 이벤트로 자유로운 DOM 조작{" "}
        <br /> &nbsp;&nbsp; / 배열 및 객체 관리로 백그라운드 로직 설계 <br />
        <br />
        <SubColor>❏ 리액트</SubColor> : 상태관리, 데이터 페칭으로 SPA 구현
        <br /> &nbsp;&nbsp; / Next.js로 SSR 및 SEO 구성
        <br />
        <br />
        <SubColor>❏ Node.js</SubColor> : Mongo DB를 활용한 기초적인 REST API
        설계
      </p>
      <br />
    </>
